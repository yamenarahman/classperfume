...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Class-Perfume - Single Portfolio Post v1</title>
		<meta charset="utf-8">
			...
			<section class="breadcrumbs">
				<div class="container">
					<ul class="horizontal_list clearfix bc_list f_size_medium">
						...
						<li><a href="#" class="default_t_color">Product Info</a></li>
					</ul>
				</div>
			</section>
			<!--content-->
				...
				<div class="container">
					<div class="d_table full_width d_xs_block m_bottom_25">
						<div class="d_table_cell v_align_m d_xs_block m_xs_bottom_15">
							<h2 class="tt_uppercase color_dark">Product Name</h2>
						</div>
						<div class="d_table_cell v_align_m t_align_r d_xs_block">
							<div class="d_inline_b d_xs_block clearfix">
								<a href="#" class="button_type_7 bg_light_color_1 color_dark tr_delay_hover r_corners mw_0 box_s_none bg_cs_hover f_left d_inline_b f_size_large t_align_c vc_child"><i class="fa fa-angle-left m_left_0 m_right_0 d_inline_middle"></i></a>
								...
								<a href="#" class="button_type_7 bg_light_color_1 color_dark tr_delay_hover r_corners mw_0 box_s_none bg_cs_hover f_left d_inline_b vc_child f_size_large t_align_c m_left_5"><i class="fa fa-angle-right m_left_0 m_right_0 d_inline_middle"></i></a>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						<section class="col-lg-8 col-md-8 col-sm-8">
						  <div class="photoframe r_corners shadow wrapper m_bottom_45">
							  <img src="images/portfolio_img_39.jpg" alt="" class="tr_all_long_hover">
							</div>
                            
                            <h2 class="tt_uppercase color_dark m_bottom_30">Comments</h2>
                            
 <div class="m_bottom_45">
								<!--comment first level-->
								<div class="clearfix comment_wrap m_bottom_25">
									<!--comment author photo-->
									<img src="images/testimonial_img_1.jpg" class="f_left circle" alt="">
								...
								<div class="clearfix comment_wrap m_left_20 m_bottom_25">
									<!--comment author photo-->
									<img src="images/testimonial_img_2.jpg" class="f_left circle" alt="">
									<div class="comment_content_wrap">
										<header class="m_bottom_5">
								...
								<div class="clearfix comment_wrap">
									<!--comment author photo-->
									<img src="images/testimonial_img_3.jpg" class="f_left circle" alt="">
									<div class="comment_content_wrap">
										<header class="m_bottom_5">
                            	...
                            	<h2 class="tt_uppercase color_dark m_bottom_30">Add Comment</h2>
								...
								<ul>
									...
									<li class="m_bottom_20">
										<img src="images/capcha.jpg" alt="" class="v_align_bottom">
          ...
          <br/>                  
						...
						<aside class="col-lg-4 col-md-4 col-sm-4 m_xs_bottom_30">
							<h5 class="fw_medium m_bottom_10">About Products</h5>
							...
							<table class="about_project full_width m_bottom_10">
								...
								<tr>
									<td>Category:</td>
									<td><a href="#" class="color_dark">Spray</a>, </td>
								</tr>
								<tr>
									<td>Tags:</td>
